...
void masterWrite(FILE *ofPTR, Data Client) {
    ...
    while (scanf("%d%20s%20s%20s%20s%20lf%20lf%20lf", &Client.Number, Client.Name,
        ...
        fprintf(ofPTR, "%-12d%-11s%-11s%-16s%20s%12.2f%12.2f%12.2f\n", Client.Number,
                Client.Name, Client.Surname, Client.addres,
...
void blackRecord(FILE *ofPTR, FILE *ofPTR_2, FILE *blackrecord, Data client_data, Data transfer) {
    while (fscanf(ofPTR, "%d%20s%20s%20s%20s%20lf%20lf%20lf", &client_data.Number,
